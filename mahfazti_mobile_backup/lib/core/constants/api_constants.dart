class ApiConstants {
  ...
  static const String weeklyReport = '/api/reports/weekly';

  static const String monthlyReport = '/api/reports/monthly';

  static const String yearlyReport = '/api/reports/yearly';
}
