...
class IncomeRepositoryImpl implements IncomeRepository {
  ...
  Future<Income> getIncomeById(
    ...
    final model = await _remoteDataSource.getIncomeById(id);
  ...
  Future<Income> createIncome({
    ...
    final model = await _remoteDataSource.createIncome(request);
  ...
  Future<Income> updateIncome({
    ...
    final model = await _remoteDataSource.updateIncome(
      id,
      request,
    );
